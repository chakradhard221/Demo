package com.tps.AccountingService.Utils;
...
public class AccountingServiceUserType implements UserType {
	...
	public void nullSafeSet(PreparedStatement ps, Object value, int idx, SharedSessionContractImplementor session)
		...
		try {
			...
			throw new RuntimeException("Failed to convert Invoice to String: "
					+ ex.getMessage(), ex);
		}
	}
	...
	public Serializable disassemble(Object value) throws HibernateException {
		...
		throw new SerializationException(String.format(
				"Cannot serialize '%s', %s is not Serializable.", value,
				value.getClass()), null);
	}
